...
from mlb_xgb import train_xgb_with_optuna
from mlb_lgb import train_lgb_with_optuna
...
output_df.to_csv('predictions_stacking.csv', index=False)
print("Predictions saved to 'predictions_stacking.csv'")


# # XGBoost
# print('train xgb learner :\n')
# xgb_model = XGBClassifier(random_state=101)
# xgb_model.fit(X_sub_train, y_sub_train)
# evaluate_model(xgb_model, X_sub_train, y_sub_train, X_val, y_val)

# # LightBGM
# print('train lgb learner :\n')
# light_gbm = LGBMClassifier(random_state=101, verbosity=-1)
# light_gbm.fit(X_sub_train, y_sub_train)
# evaluate_model(light_gbm, X_sub_train, y_sub_train, X_val, y_val)

# # CatBoost
# print('\nCatBoost\n')
# cat_model = CatBoostClassifier(random_state=101, verbose=0)
# cat_model.fit(X_sub_train, y_sub_train)
# evaluate_model(cat_model, X_sub_train, y_sub_train, X_val, y_val)
